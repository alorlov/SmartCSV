...
export default class LibraryAutocomplete extends Autocomplete{
  constructor() {
    super()
  ...
  subscribe (editor, syntax, cellEditorElement, cellEditor) {
    ...
    this.autocompleteSubscriptions.add(this.onDidConfirmSelection(item => {
      ...
      cellEditor.getBuffer().setText(prefix + item.getName() + suffix)
