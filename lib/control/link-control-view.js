...
class LinkControlView extends HTMLElement {
  initialize(button) {
    this.button = button;
...
export default document.registerElement('smartcsv-control-link', {prototype: LinkControlView.prototype, extends: 'span'});
