...
export default class Database {
  ...
  constructor() {
    ...
    this.info = {
      host: atom.config.get('elitecsv.db.host'),
      user: atom.config.get('elitecsv.db.user'),
      password: atom.config.get('elitecsv.db.password'),
      database: atom.config.get('elitecsv.db.database')
    }
