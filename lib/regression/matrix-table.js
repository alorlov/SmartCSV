...
export default class MatrixTable extends Table {
  ...
  setAddons(addons) {
    ...
    this.autocomplete.appendEditorTo(this.tableElement)
  }
  ...
  insertVars (item, letter, optional = false) {
    this.libraryAutocompleteModel.insertVars(item, letter, optional, this.editor, this.syntax)
  }

  openLibraryAutocomplete(query) {
    // this.autocomplete.attachTo(this.tableElement)
    ...
    this.autocomplete.setEditorPosition(cellEditorElement.style.top, cellEditorElement.style.left)
    this.libraryAutocompleteModel.subscribe(this.editor, this.syntax, cellEditorElement)
