...
import LibraryAutocomplete from '../autocomplete/library-suggestion-list'
import LibraryWatch from '../library/library-watch'
import DictionarySuggestionList from '../autocomplete/dictionary-suggestion-list'
import DictionaryWatch from '../library/dictionary-watch'
...
export default class MatrixTable extends Table {
  ...
  static initForEditor (editor) {
    const matrixEditor = new MatrixTable(editor)
    matrixEditor.setAutocomplete(MatrixTable.getLibrarySuggestionList())
  }

  static getLibrarySuggestionList() {
  ...
  static getDictionarySuggestionList() {

    if (this.dictionaryAutocomplete) {
      return this.dictionaryAutocomplete
    }

    this.dictionary = new DictionaryWatch()
    this.dictionaryAutocomplete = new DictionarySuggestionList()

    this.dictionary.onDidChangeItems(items => {
      this.dictionaryAutocomplete.setItems(items)
    })
