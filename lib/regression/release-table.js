...
export default class ReleaseTable extends Table {
  ...
  extendTableElement () {
    ...
    table.startCellEdit = () => {
      ...
      this.store.getStoryReport(cell.storyID, cell.runID)
      .then(report => {
        let newReport = this.report.addReport(cell.matrixPath, report, cell.runID)
        this.report.showReport(cell.matrixPath, cell.runID)
        let uriData = {}
        this.openFile(cell.matrixPath, uriData)
      })
      return
    }
  }
