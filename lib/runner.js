...
export default class Runner {
  constructor(report, mediator) {
    ...
    this.setOption('stop-method', 'all')
    this.setOption('save-report-file', true)
  ...
  //
  //   let request = {
  //       'start': this.createRunRequest(false)
  //   }
  //
  //   if (!this.isStarted()) {
  //     this.writeCommand(request);
  //   }
  //   return this.toggle();
  // }
  //
  // toggleRunFrom() {
  //   let request = {
  //       'start': this.createRunRequest(true)
  //   }
  //
  //   if (!this.isStarted()) {
  //     this.writeCommand(request);
