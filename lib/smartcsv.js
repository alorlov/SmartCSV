...
export default {
  ...
  activate(state) {
    ...
    // Normalize paths
    let path = atom.config.get('smartcsv.projectPath')
    atom.config.set('smartcsv.projectPath', _.capitalize(path))
    ...
    */
    ...
    runnerView = new RunnerView(new Runner(this.reportView))
