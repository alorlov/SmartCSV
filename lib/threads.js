...
export default class Threads {
  ...
  entryClicked(e) {
    ...
    switch (entry.dataset.type) {
      ...
      case 'report-item': this.mediator.handleClickThreadReportItem(thread.getName(), entry.dataset.id); break
  ...
  addThread(name) {
    ...
    this.subscriptions.add(reportModel.onDidNewItems(items => model.addReportItems(items)))
